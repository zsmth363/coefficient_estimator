...
class Coefficient_Estimator:
        ...
        for epoch in range(self.num_epochs):
            ...
            with torch.no_grad():
                for val_seq, val_target in test_loader:
                    ...
                    correct += (preds == val_target.squeeze()).sum().item()
    ...
    def predict_sequence(self, sequence):
        ...
        quantized_value = pred_class * self.target_quantization_step
        return quantized_value, pred_class
    ...
    def evaluate_unseen(self, idx_range):
        ...
        for i in range(len(sequences)):
            ...
            print(f"Actual Coeffcient: {actual_zip[i][self.coef_index]:.4f}")
